...
fn string_smoke_fixture_runs() {
    ...
    let built = ensure_built_project("string_smoke");
...
fn string_clone_fixture_runs() {
    ...
    let built = ensure_built_project("string_clone");
...
fn string_partialeq_fixture_runs() {
    ...
    let built = ensure_built_project("string_partialeq");
...
fn string_fmt_fixture_runs() {
    ...
    let built = ensure_built_project("string_fmt");
...
fn string_fmt_bool_fixture_runs() {
    ...
    let built = ensure_built_project("string_fmt_bool");
