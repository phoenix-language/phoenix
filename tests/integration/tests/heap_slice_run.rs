...
fn heap_slice_fixture_runs() {
    ...
    let built = ensure_built_project("heap_slice");
...
fn heap_slice_oob_index_fails_at_runtime() {
    ...
    let built = ensure_built_project("heap_slice_oob");
...
fn heap_slice_store_round_trip() {
    ...
    let built = ensure_built_project("heap_slice_store");
...
fn heap_slice_nested_index_store_round_trip() {
    ...
    let built = ensure_built_project("heap_slice_nested_index");
