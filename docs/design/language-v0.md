...
**Phase 7 compiler gates:** Phases 1–6 and Phase 7 partials (heap slices V0-062, trait default bodies V0-063, multi-param `Result` match V0-064) are **shipped**; pre-announce verification (`examples/errors`, `just pre-commit`) remains per [mvp-finish-todo.md](../mvp-finish-todo.md). See [language-v0-completion-roadmap.md](language-v0-completion-roadmap.md).
